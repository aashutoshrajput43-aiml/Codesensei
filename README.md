...
![CodeSensei UI Preview](link-to-your-screenshot-image.png) *(Note: Replace with your actual project screenshot link)*
...
* **1-Click Optimization:** Even if the code is flawless, the tool provides a modernized, elegant refactoring of the source code along with Time/Space complexity analysis.
* **Premium UI/UX:** Built with a modern dark theme and seamless Glassmorphism effects for an immersive developer experience.

## 🛠️ Tech Stack

* **Front-End:** Semantic HTML5, Custom CSS3 (Glassmorphism & Advanced Animations), Vanilla JavaScript
...
1. Clone the repository:
   ...
   \`\`\`
2. Open the project folder and insert your own active Gemini API key in `Code.js`:
   \`\`\`javascript
   const API_KEY = "YOUR_GEMINI_API_KEY";
   \`\`\`
3. Open `index.html` in your favorite browser. No local server required!
